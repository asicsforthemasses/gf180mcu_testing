...
def clone():
    os.system("git clone --recurse-submodules https://github.com/google/globalfoundries-pdk-libs-gf180mcu_fd_sc_mcu7t5v0")
...
"""
    ...
    for fn in files:
        ...
        if (fn.name.endswith("_tech.lef")):
            os.system('cp ' + fn.as_posix() + ' .')
            continue
...
clone()
process('globalfoundries-pdk-libs-gf180mcu_fd_sc_mcu7t5v0', 'gf180mcu_fd_sc_mcu7t5v0.lef')
